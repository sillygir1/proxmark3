...
make clean && CFLAGS="-L$LZ4_PATH -I$LZ4_PATH -L$BZIP2_PATH -I$BZIP2_PATH -I$DUO_SDK/rootfs/usr/include -I$PILK_SOFTWARE/lvgl/ -I$PILK_SOFTWARE/lvgl-launcher/src/ -I$PILK_SOFTWARE/duo-battery -I$PILK_SOFTWARE/duo-encoder-kb" make client cpu_arch=generic SKIPREVENGTEST=1 SKIPWHEREAMISYSTEM=1 SKIPBT=1 SKIPQT=1 SKIPREADLINE=1 SKIPLINENOISE=1 SKIPLUASYSTEM=1 SKIPJANSSONSYSTEM=1 SKIPPYTHON=1 SKIPGD=1 -j